...
class RowFloatingButtons extends StatefulWidget {
  ...
  final int index;
  final String id;
  RowFloatingButtons({this.weight, this.id, this.index});
  @override
                                ...
                                children: [
                                  ...
                                  TextButton.icon(
                                    onPressed: () => Navigator.pushNamed(
                                        ...
                                        arguments: {
                                          'txt':
                                              'enter le nouveaux prix unitaire',
                                          'type': 'number',
                                          'prop': 'price',
                                          'id': pm.docs[widget.index].id,
                                        }),
                                    ...
                                    label: Flexible(
                                        child: Text('changer prix unitaire')),
                                  ),
                                  TextButton.icon(
                                    onPressed: () => Navigator.pushNamed(
                                        context, '/changer_material_property',
                                        arguments: {
                                          'txt':
                                              'enter le nouveaux poid/litrage',
                                          'type': 'number',
                                          'prop': 'weight',
                                          'id': pm.docs[widget.index].id,
                                        }),
                                    ...
                                    label: Flexible(
                                        child: Text('changer poid/litrage')),
                                  ),
                                  TextButton.icon(
                                    onPressed: () => Navigator.pushNamed(
                                        context, '/changer_material_property',
